...
## 이슈 [리팩터링의 방법]
1. 안건을 올린 이유 발표
- 코드의 크기가 커지면서 코드 관리(유지보수)가 힘들어지고 있습니다. 이러한 경우, 객체 간의 관계를 관리하기 복잡해질 뿐 아니라 종래에 가서는 어디서부터 건드려야 할 지 모를 수도 있습니다. 이에 따라 코드를 관리하고 유지보수를 쉽게 하는 목표를 이루고자 리팩터링에 대해 질문하게 되었습니다.
